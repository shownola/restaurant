class ProductsController < ApplicationController
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:name, :description, :price, :image, :category_id, :dairy_free, :glutten_free, :kosher, :peanut_free, :vegan, :vegetarian, :available, :catering, :featured)
    end
end
